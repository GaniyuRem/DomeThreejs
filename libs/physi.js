window.Physijs = (function() {
	...
	var SUPPORT_TRANSFERABLE,
		...
		EvenFence, // class to provide simple event methods
	...
	EvenFence.prototype.addEventListener = function( event_name, callback ) {
		if ( !this._eventListeners.hasOwnProperty( event_name ) ) {
			this._eventListeners[event_name] = [];
		}
		this._eventListeners[event_name].push( callback );
	};
	EvenFence.prototype.removeEventListener = function( event_name, callback ) {
		var index;
	...
	EvenFence.prototype.dispatchEvent = function( event_name ) {
		var i,
	...
	EvenFence.make = function( obj ) {
		obj.prototype.addEventListener = EvenFence.prototype.addEventListener;
		obj.prototype.removeEventListener = EvenFence.prototype.removeEventListener;
		obj.prototype.dispatchEvent = EvenFence.prototype.dispatchEvent;
	};
